...
CLUSTERED="true"
JIRA_NODE_ID="${JIRA_NODE_ID:-jira_node_}"
EHCACHE_PEER_DISCOVERY="${EHCACHE_PEER_DISCOVERY:-default}"
EHCACHE_LISTENER_HOSTNAME="${EHCACHE_LISTENER_HOSTNAME:-NONE}"
EHCACHE_LISTENER_PORT="${EHCACHE_LISTENER_PORT:-40001}"
EHCACHE_OBJECT_PORT="${EHCACHE_OBJECT_PORT:-dynamic}"
EHCACHE_LISTENER_SOCKETTIMEOUTMILLIS="${EHCACHE_LISTENER_SOCKETTIMEOUTMILLIS:-2000}"
EHCACHE_MULTICAST_ADDRESS="${EHCACHE_MULTICAST_ADDRESS:-NONE}"
EHCACHE_MULTICAST_PORT="${EHCACHE_MULTICAST_PORT:-NONE}"
EHCACHE_MULTICAST_TIMETOLIVE="${EHCACHE_MULTICAST_TIMETOLIVE:-NONE}"
EHCACHE_MULTICAST_HOSTNAME="${EHCACHE_MULTICAST_HOSTNAME:-NONE}"
